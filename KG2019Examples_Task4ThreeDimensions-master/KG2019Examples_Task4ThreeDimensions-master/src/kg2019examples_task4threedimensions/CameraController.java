...
public class CameraController implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        if (e.isControlDown()) {
            ...
            camera.modifyProjection(Matrix4Factories.centralProjection(delta*5f, Matrix4Factories.Axis.Y));
            camera.modifyProjection(Matrix4Factories.centralProjection(delta*5f, Matrix4Factories.Axis.X));
        } else {
